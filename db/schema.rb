...
ActiveRecord::Schema.define(version: 2023_05_17_161050) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.integer "subject_id_id", null: false
    t.integer "action_type_id", null: false
    t.boolean "check_status", default: false, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["action_type_id"], name: "index_notifications_on_action_type_id"
    t.index ["subject_id_id"], name: "index_notifications_on_subject_id_id"
    t.index ["subject_type_id"], name: "index_notifications_on_subject_type_id"
